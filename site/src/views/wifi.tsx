  ...
  return (
    <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
      <div class="flex items-center justify-center mb-8">
        <div class="bg-[#D84315] p-4 rounded-full">
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} class="space-y-6">
          <div>
            ...
            <div class="relative">
              ...
              <input
                ...
                required
                class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#D84315] focus:border-transparent"
          ...
          <button
            type="submit"
            disabled={isLoading}
            class={`w-full py-3 px-4 bg-[#D84315] text-white font-medium rounded-lg 
